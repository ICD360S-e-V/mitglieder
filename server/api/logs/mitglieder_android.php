 ...
 *   - {v:1, iv, data}  → AES-256-GCM startup transcript → mitglieder_android/YYYY-MM-DD.log
 *   - {mitgliedernummer, logs[...]} → legacy plain text → mitglieder_android/<mn>_YYYY-MM-DD.log
 */
...
if ($data && ($data['v'] ?? 0) === 1 && !empty($data['iv']) && !empty($data['data'])) {
    ...
    $dir  = __DIR__ . '/../data/logs/mitglieder_android';
    @mkdir($dir, 0750, true);
...
$logsDir = __DIR__ . '/../../logs/mitglieder_android';
