 ...
 *   {v:1, iv, data}          → AES-256-GCM-Startprotokoll → api/data/logs/mitglieder_windows/
 *   {mitgliedernummer, logs} → Klartextstrom              → <webroot>/logs/mitglieder_windows/
 *
