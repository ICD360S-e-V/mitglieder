...
class AppLocalizationsHr extends AppLocalizations {
  ...
  String get claudiuDiagnosticSends10 =>
      'Koliko je puta aplikacija poslala podatke (samo broj, bez sadržaja)';

  @override
  String get claudiuDiagnosticSends11 =>
      'Kako sustav razvrstava aplikaciju i koliko se brzo prazni baterija';
  ...
  @override
  String get claudiuDiagnosticTech1 => 'Šalje se svakih 15 minuta';
  ...
  @override
  String get signaturWartetZweiteUnterschrift => 'Čeka se drugi potpis';
  ...
  String get themeScheduleHint =>
      'Tamno od 20:00 do 6:00, ostatak dana svijetlo.';
  ...
  @override
  String get fernwartungAnfrageTitel => 'Zahtjev za udaljenu podršku';

  @override
  String fernwartungAnfrageText(String name) {
    return '„$name\" želi vidjeti i upravljati vašim zaslonom kako bi vam pomogao. Ništa se ne prenosi bez vašeg pristanka.';
  }

  @override
  String get fernwartungAnfrageHinweis =>
      'Cijelo vrijeme vidjet ćete obavijest i možete pritisnuti „Stop\" u bilo kojem trenutku.';

  @override
  String get fernwartungErlauben => 'Dopusti';

  @override
  String get fernwartungAblehnen => 'Odbij';

  @override
  String get fernwartungVerbindet => 'Povezivanje …';

  @override
  String get fernwartungAktiv => 'Vaš zaslon se dijeli';

  @override
  String get fernwartungStopp => 'Stop';

  @override
  String get fernwartungMikroAus => 'Isključi mikrofon';
  ...
  @override
  String get klingelTitel => 'Poziv na zaključanom zaslonu';

  @override
  String get klingelZweck =>
      'Ako uprava pozove dok je uređaj zaključan, preko zaključanog zaslona pojavljuje se zaslon s „Prihvati” i „Odbij” — bez potrebe da prvo otključate uređaj.';

  @override
  String get klingelAndroidHinweis =>
      'Android za to zahtijeva dopuštenje „Obavijesti na cijelom zaslonu”. Može se dati samo u postavkama sustava.';

  @override
  String get klingelOhneErlaubnis =>
      'Bez dopuštenja ostaje obavijest s „Prihvati” i „Odbij”. Poziv se i dalje može prihvatiti, samo ne na cijelom zaslonu.';

  @override
  String get klingelErteilt =>
      'Dano – zaslon se pojavljuje preko zaključanog zaslona.';

  @override
  String get klingelNichtErteilt => 'Nije dano – pojavljuje se samo obavijest.';

  @override
  String get klingelVonHand =>
      'Zaslon postavki nije se mogao otvoriti. Ručno: Postavke ▸ Aplikacije ▸ Poseban pristup ▸ Obavijesti na cijelom zaslonu.';
