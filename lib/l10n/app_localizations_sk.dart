...
class AppLocalizationsSk extends AppLocalizations {
  ...
  @override
  String get benachrichtigungTitel => 'SMS pripomienky';
  ...
  @override
  String get benachrichtigungJa => 'Áno';

  @override
  String get benachrichtigungNein => 'Nie';

  @override
  String get benachrichtigungSpaeter => 'Rozhodnúť neskôr';

  @override
  String get benachrichtigungSpeichern => 'Uložiť';

  @override
  String get benachrichtigungGespeichert => 'Ďakujeme, uložené.';

  @override
  String get benachrichtigungenLeer => 'Žiadne oznámenia';

  @override
  String get benachrichtigungenAlleGelesen => 'Označiť všetko ako prečítané';
  ...
  @override
  String get kontaktNochAktuell => 'Sú tieto údaje stále aktuálne?';

  @override
  String get kontaktWarumFragen =>
      'Aby ste o nič neprišli, krátko sa pýtame každé tri mesiace. Dostanete šesťmiestny kód.';

  @override
  String kontaktBestaetigtAm(Object datum) {
    return 'potvrdené $datum';
  }
  ...
  @override
  String get fernwartungAnfrageTitel => 'Žiadosť o vzdialenú podporu';

  @override
  String fernwartungAnfrageText(String name) {
    return '„$name\" chce vidieť a ovládať vašu obrazovku, aby vám pomohol. Bez vášho súhlasu sa nič neprenáša.';
  }

  @override
  String get fernwartungAnfrageHinweis =>
      'Po celý čas uvidíte upozornenie a kedykoľvek môžete ťuknúť na „Stop\".';

  @override
  String get fernwartungErlauben => 'Povoliť';

  @override
  String get fernwartungAblehnen => 'Odmietnuť';

  @override
  String get fernwartungVerbindet => 'Pripája sa …';

  @override
  String get fernwartungAktiv => 'Vaša obrazovka sa zdieľa';

  @override
  String get fernwartungStopp => 'Stop';

  @override
  String get fernwartungMikroAus => 'Vypnúť mikrofón';
  ...
  @override
  String get anruffensterTitel => 'Okno hovoru nad ostatnými aplikáciami';

  @override
  String get anruffensterZweck =>
      'Ak počas hovoru opustíte aplikáciu, napríklad kvôli prehliadaču, malé okno zostane nad druhou aplikáciou. Dotykom sa vrátite k hovoru; vedľa je tlačidlo na ukončenie.';

  @override
  String get anruffensterAndroidHinweis =>
      'Android na to vyžaduje povolenie „Zobrazovanie nad ostatnými aplikáciami“. Dá sa udeliť iba v nastaveniach systému.';

  @override
  String get anruffensterOhneErlaubnis =>
      'Bez povolenia hovor zostáva spojený; chýba iba okno. Späť sa potom dostanete cez upozornenie.';

  @override
  String get anruffensterErteilt => 'Udelené – okno sa bude zobrazovať.';

  @override
  String get anruffensterNichtErteilt => 'Neudelené – okno sa nezobrazí.';

  @override
  String get anruffensterVonHand =>
      'Obrazovku nastavení sa nepodarilo otvoriť. Ručne: Nastavenia ▸ Aplikácie ▸ ICD360S ▸ Zobrazovanie nad ostatnými aplikáciami.';

  @override
  String get anruffensterNurAndroid => 'Okno hovoru existuje iba v Androide.';

  @override
  String get anrufLaeuft => 'Prebieha hovor';
  ...
  @override
  String get klingelTitel => 'Hovor na uzamknutej obrazovke';

  @override
  String get klingelZweck =>
      'Ak vedenie zavolá, keď je zariadenie uzamknuté, nad uzamknutou obrazovkou sa zobrazí obrazovka s „Prijať” a „Odmietnuť” — zariadenie nemusíte najprv odomykať.';

  @override
  String get klingelAndroidHinweis =>
      'Android na to vyžaduje povolenie „Upozornenia na celú obrazovku”. Dá sa udeliť iba v systémových nastaveniach.';

  @override
  String get klingelOhneErlaubnis =>
      'Bez povolenia zostane upozornenie s „Prijať” a „Odmietnuť”. Hovor sa dá stále prijať, len nie na celú obrazovku.';

  @override
  String get klingelErteilt =>
      'Udelené – obrazovka sa zobrazí nad uzamknutou obrazovkou.';

  @override
  String get klingelNichtErteilt => 'Neudelené – zobrazí sa iba upozornenie.';

  @override
  String get klingelVonHand =>
      'Obrazovku nastavení nebolo možné otvoriť. Ručne: Nastavenia ▸ Aplikácie ▸ Špeciálny prístup ▸ Upozornenia na celú obrazovku.';
  ...
  @override
  String get pdfWerkzeugDateiWaehlen => 'Vybrať PDF';

  @override
  String get extrasTitel => 'Osobitné funkcie';

  @override
  String get pdfWerkzeugUnterschriftNochmal => 'Nakresliť znova';

  @override
  String get pdfWerkzeugMitDatum => 'Pridať dátum pod podpis';

  @override
  String get pdfWerkzeugHinweisRechtlich =>
      'Toto je pohodlie pre vaše vlastné dokumenty — nájomnú zmluvu, formulár, výpoveď. Nemá to nič spoločné s podpismi, ktoré od vás žiada spolok: tam je kód cez SMS a pečať, tu nie.';

  @override
  String get pdfWerkzeugLaeuft => 'Vkladá sa do dokumentu …';

  @override
  String get pdfWerkzeugUnterschriftMalen => 'Nakresliť podpis';

  @override
  String get extrasPdfUnterschreibenText =>
      'Podpíšte rukou vlastný dokument bez toho, aby ste ho dali cudzej internetovej stránke.';

  @override
  String get pdfWerkzeugKeineDatei => 'Zatiaľ nie je vybraný žiadny dokument.';

  @override
  String get pdfWerkzeugPlatzierenHinweis =>
      'Podpis sa dá posúvať; v rohu sa zväčšuje a zmenšuje.';

  @override
  String get pdfWerkzeugFehlerAllgemein =>
      'Nepodarilo sa to. Skúste to prosím znova.';

  @override
  String get pdfWerkzeugFertig => 'Hotovo. Podpísaný dokument bol uložený.';

  @override
  String get pdfWerkzeugFertigstellen => 'Vložiť podpis';

  @override
  String get pdfWerkzeugLeer => 'Zatiaľ nebolo nič nakreslené.';

  @override
  String get pdfWerkzeugOeffnen => 'Otvoriť';

  @override
  String get extrasUntertitel => 'Nástroje, ktoré majú len členovia.';

  @override
  String get pdfWerkzeugUebernehmen => 'Použiť';

  @override
  String get extrasPdfUnterschreibenTitel => 'Podpísať vlastné PDF';

  @override
  String get pdfWerkzeugFehlerZuGross =>
      'Dokument je príliš veľký (najviac 20 MB).';
  ...
  @override
  String get pdfWerkzeugFehlerOeffnen => 'Toto PDF sa nepodarilo otvoriť.';

  @override
  String get pdfWerkzeugTitel => 'Podpísať vlastné PDF';
  ...
  String get extrasRechnerText =>
      'Sčítanie, odčítanie, percentá — so zátvorkami a históriou, ktorá patrí len vám.';

  @override
  String get rechnerTitel => 'Kalkulačka';

  @override
  String get rechnerVerlauf => 'História';

  @override
  String get rechnerZurueck => 'Späť na kalkulačku';

  @override
  String get rechnerVorrang =>
      'Násobenie pred sčítaním: 2 + 3 × 4 = 14. Pre iné poradie použite zátvorky.';

  @override
  String get rechnerKopieren => 'Kopírovať';

  @override
  String get rechnerKopiert => 'Výsledok skopírovaný';

  @override
  String get rechnerLeer => 'Zatiaľ nič vypočítané.';

  @override
  String get rechnerVerlaufErklaerung =>
      'Každý dokončený výpočet sa ukladá — zašifrovane a viditeľne len pre tento účet.';

  @override
  String get rechnerLeerWeilUngespeichert =>
      'Tu nič nie je — výpočty tejto relácie sa nepodarilo uložiť.';

  @override
  String get rechnerWeiterrechnen =>
      'Ťuknutím na riadok budete počítať ďalej s jeho výsledkom.';

  @override
  String get rechnerAllesLoeschen => 'Zmazať všetko';

  @override
  String get rechnerLoeschen => 'Zmazať';

  @override
  String get rechnerZeileLoeschenFrage => 'Zmazať tento výpočet?';

  @override
  String get rechnerZeileLoeschenTooltip => 'Zmazať tento výpočet';

  @override
  String get rechnerNichtRueckgaengig => 'To sa nedá vrátiť späť.';

  @override
  String get rechnerVerlaufLoeschenFrage => 'Zmazať históriu?';

  @override
  String get rechnerVerlaufLoeschenText =>
      'Všetky uložené výpočty budú odstránené. To sa nedá vrátiť späť.';

  @override
  String get rechnerLoeschenFehlgeschlagen => 'Mazanie zlyhalo';

  @override
  String rechnerVerlaufNichtLadbar(String grund) {
    return 'Históriu sa nepodarilo načítať — nie je teda prázdna, ale neznáma. ($grund)';
  }

  @override
  String get rechnerEineNichtGespeichert =>
      'Jeden výpočet sa nepodarilo zapísať do histórie. Výsledok hore napriek tomu platí.';

  @override
  String rechnerNichtGespeichert(int anzahl) {
    return '$anzahl výpočtov sa nepodarilo zapísať do histórie. Výsledky napriek tomu platia.';
  }
  ...
  @override
  String get rechnerFehlerZuGross => 'Číslo je príliš veľké';

  @override
  String get rechnerFehlerKlammerOhneAnfang =>
      'Zatváracia zátvorka bez otváracej';

  @override
  String get rechnerFehlerKlammerOffen => 'Neuzavretá zátvorka';

  @override
  String get rechnerFehlerDurchNull => 'Delenie nulou';
  ...
  String rechnerFehlerZeichen(String zeichen) {
    return 'Neočakávaný znak: $zeichen';
  }
