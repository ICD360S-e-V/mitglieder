...
class AppLocalizationsBg extends AppLocalizations {
  ...
  String get claudiuDiagnosticSends10 =>
      'Колко пъти приложението е изпратило данни (само броят, без съдържание)';

  @override
  String get claudiuDiagnosticSends11 =>
      'Как системата класифицира приложението и колко бързо се изтощава батерията';
  ...
  @override
  String get claudiuDiagnosticTech1 => 'Изпраща се на всеки 15 минути';
  ...
  @override
  String get benachrichtigungTitel => 'SMS напомняния';
  ...
  @override
  String get benachrichtigungSpaeter => 'Решаване по-късно';

  @override
  String get benachrichtigungSpeichern => 'Запазване';

  @override
  String get benachrichtigungGespeichert => 'Благодарим, запазено.';

  @override
  String get benachrichtigungenLeer => 'Няма известия';

  @override
  String get benachrichtigungenAlleGelesen => 'Отбележи всички като прочетени';
  ...
  String get signaturNichtsOffen =>
      'В момента няма документи, които чакат Вашия подпис.';

  @override
  String get signaturStatusOffen => 'Чака Вашия подпис';

  @override
  String get signaturStatusSigniert => 'Подписано от Вас';

  @override
  String get signaturStatusAbgelehnt => 'Отхвърлено от Вас';

  @override
  String get signaturStatusWiderrufen => 'Оттеглено от сдружението';

  @override
  String get signaturStatusAbgelaufen => 'Срокът изтече';

  @override
  String signaturBitteGanzLesen(int gelesen, int gesamt) {
    return 'Моля, прочетете документа докрай (страница $gelesen от $gesamt).';
  }

  @override
  String get signaturWeiterZurUnterschrift => 'Продължете към подписа';

  @override
  String get signaturAblehnen => 'Отхвърляне';

  @override
  String get signaturAblehnenHinweis =>
      'Сдружението ще бъде уведомено за това. Можете да посочите причините си.';

  @override
  String get signaturAblehnenGrund => 'Причина (по желание)';

  @override
  String get signaturMitFingerHinweis => 'Подпишете се с пръст в бялото поле.';

  @override
  String get signaturNochmal => 'Още веднъж';

  @override
  String get signaturZurueckZumDokument => 'Обратно към документа';

  @override
  String get signaturCodeAnfordern => 'Заявете код по SMS';

  @override
  String get signaturCodeUnterwegs => 'Кодът е на път.';

  @override
  String signaturCodeGesendetAn(String nummer) {
    return 'Изпратихме Ви код на $nummer.';
  }

  @override
  String get signaturCodeErneutSenden => 'Заявете нов код';

  @override
  String get signaturJetztUnterschreiben => 'Подпишете сега';

  @override
  String get signaturCodeFalsch => 'Кодът не е верен.';

  @override
  String get signaturCodeAbgelaufen => 'Кодът е изтекъл. Моля, заявете нов.';

  @override
  String get signaturZuVieleVersuche =>
      'Твърде много неуспешни опити. Моля, заявете нов код.';

  @override
  String get signaturKeineRufnummer =>
      'Във Вашия профил не е записан мобилен номер. Без него не можем да Ви изпратим код — моля, обърнете се към председателя на сдружението.';

  @override
  String get signaturCodeFehlgeschlagen => 'Не успяхме да изпратим кода.';

  @override
  String get signaturLeer => 'Моля, първо се подпишете.';

  @override
  String get signaturErfolg => 'Благодарим Ви — получихме Вашия подпис.';

  @override
  String get signaturFehlgeschlagen =>
      'Нещо не се получи. Моля, опитайте отново.';
  ...
  @override
  String get fernwartungAnfrageTitel => 'Заявка за отдалечена помощ';

  @override
  String fernwartungAnfrageText(String name) {
    return '„$name\" иска да вижда и управлява екрана ви, за да ви помогне. Нищо не се предава без вашето съгласие.';
  }

  @override
  String get fernwartungAnfrageHinweis =>
      'През цялото време ще виждате съобщение и можете да натиснете „Стоп\" по всяко време.';

  @override
  String get fernwartungErlauben => 'Разреши';

  @override
  String get fernwartungAblehnen => 'Откажи';

  @override
  String get fernwartungVerbindet => 'Свързване …';

  @override
  String get fernwartungAktiv => 'Екранът ви се споделя';

  @override
  String get fernwartungStopp => 'Стоп';

  @override
  String get fernwartungMikroAus => 'Изключи микрофона';

  @override
  String get fernwartungMikroAn => 'Включи микрофона';

  @override
  String virengeprueftAm(String datum) {
    return 'Проверен за вируси $datum';
  }

  @override
  String get nichtVirengeprueft => 'Не е проверен за вируси';
